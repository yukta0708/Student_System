...
<body>
    ...
    <div class="welcome-section">
        <h1 class="welcome-title">Welcome, ${userobj.name}!</h1>
        <p class="welcome-subtitle">Stay connected with your child's academic journey</p>
    </div>

    <div class="dashboard">
        <div class="card fade-in delay-1">
            <a href="parent_performance.jsp" class="card-link">
                <i class="fas fa-chart-line"></i>
                <h3 class="card-title">Performance</h3>
                <p class="card-desc">View your child's academic results and progress</p>
            </a>
        </div>

        <div class="card fade-in delay-2">
            <a href="parent_attendance.jsp" class="card-link">
                <i class="fas fa-user-check"></i>
                <h3 class="card-title">Attendance</h3>
                <p class="card-desc">Check your child's attendance records</p>
            </a>
        </div>

        <div class="card fade-in delay-3">
            <a href="parent_feedback.jsp" class="card-link">
                <i class="fas fa-comment-alt"></i>
                <h3 class="card-title">Feedback</h3>
                <p class="card-desc">Communicate with teachers and provide feedback</p>
            </a>
        </div>

        <div class="card fade-in delay-4">
            <a href="parent_notice.jsp" class="card-link">
                <i class="fas fa-bell"></i>
                <h3 class="card-title">Notices</h3>
                <p class="card-desc">View important school announcements and updates</p>
            </a>
        </div>
    </div>
